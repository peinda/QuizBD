  ...
  <nav class="navbar navbar-default navbar-fixed-top">
    <div class="imag"><img class="image" src=" ./public/image/logo-QuizzSA.png"/></div>
    <div class="container d-flex justify-content-center zone-texte">
      <h2>Le plaisir de jouer</h2>
    </div>
    <div class="container d-flex align-items-center justify-content-center zone-affichage" id="container">
    <?php 
    if(isset($_GET['user'])){
      if($_GET['user'] == 'admin'){
  ...
  require_once ('./data/inscription-bd.php');
...
$('#containerAdmin').load('pages/'+page+'.php');  
})
</script>
